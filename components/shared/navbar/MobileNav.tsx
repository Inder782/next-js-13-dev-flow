...
const NavContent = () => {
  ...
  return (
    <section className="flex h-full flex-col gap-l pt-16">
        ...
        return (
          <SheetClose asChild key={item.route}>
            <Link
              ...
              className={`${
                isActive
                  ? " flex primary-gradient rounded-lg text-light-900"
      ...
      >
        <Link href="/" className="flex items-center gap-1">
          <Image
            ...
            alt="DevFlow"
          />
          <p className="h2-bold  dark:text-light-900   font-spaceGrotesk ">
